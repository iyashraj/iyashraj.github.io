...
//       <div
//         className={`
//           flex items-center w-full space-x-4 pt-0 pb-0 mt-0 mb-0 pl-2 sm:pl-4 md:mt-6 sm:mt-4
...
//           className={`
//             rounded-full object-cover shadow-sm border-2 border-accent-blue
     ...
     {!isLarge && <a
      ...
      >
        ...
        <div className="flex flex-col justify-center text-left">
          ...
          <p
            className={`${
              isLarge ? "text-sm sm:text-base md:text-lg" : "text-xs sm:text-sm md:text-base"
            } text-text-secondary mt-1`}
          >
            Software Engineer II
          </p>
